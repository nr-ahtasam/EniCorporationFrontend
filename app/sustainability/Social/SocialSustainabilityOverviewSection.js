...
export default function SocialSustainabilityOverviewSection() {
  const sections = [
    {
      id: 1,
  ...
  return (
    <section className="w-full mx-auto px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10 py-12">
        <SustainabilityHero
          eyebrow = "Social"
        title = "Empowering People, Uplifting Communities"
       highlight = ""
      description = "At ENI Corporation, our social responsibility extends far beyond business operations—it is grounded in empowering people, ensuring workplace equity, and uplifting the communities we serve. We believe that sustainable growth must be inclusive, compassionate, and community-driven. Our social initiatives are closely aligned with several of the UN Sustainable Development Goals (SDGs), particularly SDG 3, 4, 5, 8, and 10."
        />
        {/* Dynamic sections */}
