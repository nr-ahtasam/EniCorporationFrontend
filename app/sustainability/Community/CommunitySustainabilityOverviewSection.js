...
export default function CommunitySustainabilityOverviewSection() {
  const sections = [
    {
      id: 1,
  ...
  return (
    <section className="w-full mx-auto px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10 py-12">
        <SustainabilityHero
          eyebrow = "People"
        title = "Uplifting Lives, Building Futures"
       highlight = ""
      description = "At ENI Corporation, we believe that a truly sustainable business must contribute to the well-being of the communities in which it operates. Our approach to community development is rooted in partnership, empowerment, and long-term positive impact. Through strategic CSR initiatives, we aim to create meaningful change in the lives of people across Bangladesh—supporting health, education, livelihoods, and disaster resilience. Our community programs are aligned with several UN Sustainable Development Goals (SDGs), including SDG 3 (Good Health & Well-being), SDG 4 (Quality Education), SDG 6 (Clean Water and Sanitation), and SDG 10 (Reduced Inequalities)."
        />
        {/* Dynamic sections */}
